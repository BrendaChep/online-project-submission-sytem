            ...
            <div class="w3-col m12">
              <div class="w3-card-2 w3-white">
                <div class="w3-container w3-padding">
                  <h5 class="w3-center">SUBMIT PROJECT IDEA</h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-white">  
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data" >
              ...
              <div class="w3-row">
                <div class="w3-col m4">Additional details </div>
                <div class="w3-col m8">
              ...
              <div class="w3-center">
                <button type="submit" name="submit" class="w3-padding w3-btn w3-blue">Submit proposed project</button>
              </div>            
            </form>
