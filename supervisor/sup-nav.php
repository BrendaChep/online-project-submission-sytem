...
<div class="w3-card-2">
  <div class="w3-white">
    ...
    $studentconcept = mysqli_query($dbcon, "SELECT * FROM proposalnote WHERE supervisor = '$get_user'") or die(mysqli_error());

    $concept_note = mysqli_fetch_array($studentconcept);
    $concept_num_row = mysqli_num_rows($studentconcept);
    if($concept_num_row > "0") { ?>
      <a href="supervisor-concepts.php"><button class="w3-btn w3-btn-block w3-blue w</a>3-left-align" ><i class="fa fa-sticky-note-o fa-fw w3-margin-right"></i> View Proposal Notes</button>
    <?php } 
           /* else { 
          ...
          <div class="w3-card-2 w3-round w3-white w3-center">
            <a href="../search-projects.php"><button class="w3-btn-block w3-blue w3-left-align" onclick="">Projects Archive</button></a>
          </div>
          <br />
