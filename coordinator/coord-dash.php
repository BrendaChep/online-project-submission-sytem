    ...
    <div class="w3-col m6">     
      ...
      <div class="w3-container">
        <?php 
          ...
          echo "<p>".$concept_num_row." proposal notes have been submitted. </p>";
          ...
          <?php
            ...
            if($concept_num_row > "0") { 
              ...
              if (($reccomendation="yes") && ($approval="waiting")) {
                ...
                echo "<p>There are several proposal notes to be reviewed  </p>";
              } else {
                
                echo "<p>All proposal notes have been reviewed. </p>";
              }
               ...
               ;
                ...
                echo "<p>There are no submitted proposal notes </p>";
            } 
          ?>
        </div>
      ...
      <div class="w3-card-2  ">
        ...
        <div class="w3-container">
          <?php
                ...
                echo "<p>Evaluation Activities haven't been scheduled yet. </p>";
